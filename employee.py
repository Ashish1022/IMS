...
class employee:
    def __init__(self,root):
        ...
        #********button********
        btn_search = Button(self.root,text="Save",command=self.add,cursor="hand2",font=("goudy old style",15),bg="#2196f3",fg="white").place(x=500,y=305,width=110,height=28)
        btn_update = Button(self.root,text="Update",command=self.update,cursor="hand2",font=("goudy old style",15),bg="green",fg="white").place(x=620,y=305,width=110,height=28)
        btn_delete = Button(self.root,text="Delete",command=self.delete,cursor="hand2",font=("goudy old style",15),bg="red",fg="white").place(x=740,y=305,width=110,height=28)
        btn_clear = Button(self.root,text="Clear",command=self.clear,cursor="hand2",font=("goudy old style",15),bg="grey",fg="white").place(x=860,y=305,width=110,height=28)
